...
CREATE TABLE IF NOT EXISTS negocios (
    ...
    horario_dia_inicio ENUM('Lunes','Martes','Miércoles','Jueves','Viernes','Sábado','Domingo') NULL,
    horario_dia_fin ENUM('Lunes','Martes','Miércoles','Jueves','Viernes','Sábado','Domingo') NULL,
    horario_hora_inicio TIME NULL,
    horario_hora_fin TIME NULL,
    imagen_banner VARCHAR(255) NULL,
    imagen_perfil VARCHAR(255) NULL,
    valoracion DECIMAL(2,1) NOT NULL DEFAULT 0.0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
